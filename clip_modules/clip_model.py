...
class VisualTransformer(nn.Module):
    ...
    def forward(self, x: torch.Tensor):
        ...
        img_feature = self.ln_post(img_feature)
...
def load_clip(name: str, device: Union[str, torch.device] = "cuda" if torch.cuda.is_available() else "cpu", jit=True, context_length=77):
    """Load a CLIP model
    Parameters
    ----------
    name : str
